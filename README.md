...
| Feature | LO1 Legal/Ethical | LO2 Cryptography | LO4 Monitoring/IDS |
|---------|-------------------|-------------------|---------------------|
| Download detection | User consent model, GDPR compliance | SHA-256 hash via VT API | Vulnerability assessment tool |
| File masquerading | Computer Misuse Act 1990 | File signature verification | Real-time file monitoring |
| VirusTotal | Responsible disclosure ethics | Hash-based file fingerprinting | 70-engine AV scanning |
| Gemini phishing | Privacy of email content, ICO guidelines | — | AI-powered IDS equivalent |
| Local spam scanner | Data minimisation (no API calls) | — | Signature-based detection |
| Brand database | IP and trademark law | — | Spoofing detection |
| Link preview | Informed consent before clicking | Certificate validation (HTTPS) | URL reputation monitoring |
| QR scanner | Quishing awareness, duty of care | — | Image-based threat detection |
...
- **Google Gemini 1.5 Flash** — [aistudio.google.com](https://aistudio.google.com) — AI phishing analysis
- **VirusTotal API v3** — [virustotal.com](https://virustotal.com) — URL and file hash scanning
- **jsQR v1.4.0** — [github.com/cozmo/jsQR](https://github.com/cozmo/jsQR) — QR code decoding

---

## References

- Computer Misuse Act 1990 (c. 18). Available at: https://www.legislation.gov.uk
- UK GDPR and Data Protection Act 2018. Available at: https://www.legislation.gov.uk
- NIST (2015). FIPS PUB 180-4: Secure Hash Standard. Available at: https://nvlpubs.nist.gov
- Krebs, B. (2021). SocGholish: Fake browser updates. KrebsOnSecurity.
- Kaspersky (2020). Surge in gaming-themed malware during COVID-19 lockdowns.
- VirusTotal API v3 Documentation. Available at: https://developers.virustotal.com/reference
- Chrome Extensions Manifest V3. Available at: https://developer.chrome.com/docs/extensions/mv3
- jsQR Library. Available at: https://github.com/cozmo/jsQR
- Microsoft (2023). SmartScreen and file reputation. Microsoft Security Documentation.
- ICO (2023). Employment practices and data protection: Monitoring at work.

---

## Acknowledgement of GAI Contribution

This artefact was produced using **Claude Sonnet 4.6 (Anthropic)** via Claude.ai in May 2026.

**Extent of use:** The extension was built through iterative dialogue with the AI system across a single session. All six core features were designed, architected, debugged, and refined through this agentic AI co-production workflow.

**How it was used:**
- Architecture and file structure decisions were made collaboratively through dialogue
- All JavaScript, HTML, and CSS was generated by the AI and reviewed by the student
- Debugging of Chrome MV3 CSP issues, service worker behaviour, and DOM selector failures was performed iteratively
- The 200-brand corporate database and 150+ keyword ruleset were generated by the AI and verified by the student
- The student directed all feature decisions, evaluated outputs critically, and made judgements about scope and priority

**Authenticity statement:** The core security concepts, architectural decisions, and academic framing reflect the student's own understanding developed through the CI7526 module. The AI served as a technical implementation partner; intellectual ownership of the design lies with the student.
